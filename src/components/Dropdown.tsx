        ...
        <div className="text-white-300">
            <div className="pt-3 flex">
                <button onClick={handleOpen}
                        className="flex md:text-2xl text-xl bg-black-400 md:py-3 md:px-10 rounded-full mt-5 py-1 px-10">
                    Mesa 01
            ...
            <div className="pt-2 text-center text-xl">
                ...
                <button onClick={sendMessageTrue}
                        className="mt-10 bg-black-400 md:px-10 md:py-5 md:text-2xl rounded-full text-lg px-3 py-1">
